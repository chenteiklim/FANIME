...
const setupCanvas = () => {
    ...
    setCanvasBackground();
    loadImage('assets/shirt2.png', 350, 500, 200, 100);  // Load the default image with adjusted coordinates
    setupEventListeners();
}
...
const setupEventListeners = () => {
    ...
    document.querySelector('.clear-canvas').addEventListener('click', () => {
        ...
        loadImage('assets/shirt2.png', 350, 500, 200, 100); // Reload default image
    });
